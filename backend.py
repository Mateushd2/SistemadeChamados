...
mock_tickets = {
    '1': {
        'id': '1',
        'subject': 'Problema com o Login',
        'from': 'joao.silva@email.com',
        'status': 'Aberto',
        'priority': 'Alta',
        ...
        'is_read': False,
        'messages': [
            {'text': 'Não consigo acessar minha conta.', 'timestamp': (datetime.now() - timedelta(minutes=10)).isoformat(), 'author': 'joao.silva@email.com'}
        ]
    },
    '2': {
        'id': '2',
        'subject': 'Dúvida sobre a funcionalidade X',
        'from': 'maria.souza@email.com',
        'status': 'Em Andamento',
        'priority': 'Média',
        ...
        'is_read': False,
        'messages': [
            {'text': 'Gostaria de saber como usar a funcionalidade X.', 'timestamp': (datetime.now() - timedelta(minutes=60)).isoformat(), 'author': 'maria.souza@email.com'},
            {'text': 'Estamos verificando seu chamado. Em breve entraremos em contato.', 'timestamp': (datetime.now() - timedelta(minutes=30)).isoformat(), 'author': AGENT_NAME}
        ]
    },
    '3': {
        'id': '3',
        'subject': 'Sugestão de melhoria na interface',
        'from': 'carlos.pereira@email.com',
        'status': 'Fechado',
        'priority': 'Baixa',
        ...
        'is_read': True,
        'messages': [
            {'text': 'A interface poderia ser mais clara.', 'timestamp': (datetime.now() - timedelta(hours=2)).isoformat(), 'author': 'carlos.pereira@email.com'},
            {'text': 'Obrigado pela sua sugestão! Consideramos sua ideia e encerramos o ticket.', 'timestamp': (datetime.now() - timedelta(minutes=60)).isoformat(), 'author': AGENT_NAME}
        ]
    },
}
